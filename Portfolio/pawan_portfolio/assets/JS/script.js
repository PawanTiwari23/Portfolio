...
function contact() {
  window.location.href = "https://wa.me/9798176566/";
};
...
function sendEmail() {
  ...
  <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f9f9f9;">
    <div style="background-color: #ffffff; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
      ...
      <span style="margin: 0;">&copy;Pawan Tiwari</span>
    </div>
    </div>
  </div>
`;
  ...
  Email.send({
    ...
    Username: "pawantiwari.wd.bca.22@gmail.com",
    Password: "3B90AA843D8DCA9333F0808C684A7F36C4F9",
    Username: "pawantiwari.wd.bca.22@gmail.com",
    To: 'pawantiwari.wd.bca.22@gmail.com',
    From: " pawantiwari.wd.bca.22@gmail.com",
...
document.addEventListener("visibilitychange", function () {
  if (document.visibilityState === "visible") {
    document.title = "Portfolio | Pawan Tiwari";
  } else {
